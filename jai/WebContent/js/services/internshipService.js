...
internshipModule.factory('toiJsontoString', function() {
    return function(toi){
...
internshipModule.factory('stateList', ['httpcall', '$q',function(httpcall, $q){
    var statesList = [];
...
internshipModule.factory('internshipApproveSvc', ['httpcall', '$q', function(httpcall, $q){
...
internshipModule.factory('internshipSubmit', ['httpcall', '$q', function(httpcall, $q){
